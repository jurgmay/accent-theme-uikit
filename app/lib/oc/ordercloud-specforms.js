...
function ocfilefield($parse, $resource, $451, fileReader, Security) {
    ...
    function template() {
        return [
            ...
            '<div class="uk-form-controls" ng-show="customfield.File">',
            '<input name="replace" class="uk-checkbox uk-form-small" type="checkbox" ng-model="replace"> Replace',
            '<input name="delete" class="uk-checkbox uk-form-small" type="checkbox"> Delete',
            '</div>',
